...
three-module cluster. Except where a module is noted below as a new
construction, we have found no prior Idris formalization of the
...
- [`src/LanguageDef/Quiver.idr`](../../src/LanguageDef/Quiver.idr)
  ...
  variants are straightforward specializations.
...
- [`src/LanguageDef/FinCat.idr`](../../src/LanguageDef/FinCat.idr)
  ...
  packaging via initial algebras follows `IdrisCategories`.
...
- [`src/LanguageDef/FinCatPRA.idr`](../../src/LanguageDef/FinCatPRA.idr)
  ...
  representation is a project-specific encoding.
...
- [`src/LanguageDef/UniversalCategory.idr`](../../src/LanguageDef/UniversalCategory.idr)
  ...
  structures; we're not aware of a mechanical formalism of the
  free construction of categories via adjunctions in either
  Idris or Lean.
...
- [`src/LanguageDef/SpanCospan.idr`](../../src/LanguageDef/SpanCospan.idr)
  ...
  fibration encoding is a standard Idris/Agda idiom.
...
- [`src/LanguageDef/MLQuivPoly.idr`](../../src/LanguageDef/MLQuivPoly.idr)
  ...
  development.
  We are not aware of explicit uses of quivers internal to the
  polynomial-functor category, though the components of the
  construction are completely standard.
