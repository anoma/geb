...
- [Tree Calculus](#tree-calculus)
  ...
  - [Reduction Rules](#reduction-rules)
    - [Reduction as Case Analysis](#reduction-as-case-analysis)
  - [Connection to Polynomial Functors](#connection-to-polynomial-functors)
  - [Self-Reflection](#self-reflection)
  - [Partial Combinatory Algebra](#partial-combinatory-algebra)
  - [Self-Evaluators (Book, Chapter 6)](#self-evaluators-book-chapter-6)
    - [Quotation](#quotation)
    - [Construction of bf](#construction-of-bf)
  - [Book Structure](#book-structure)
  - [Type System](#type-system)
    - [Type Grammar](#type-grammar)
    - [Tree Types and progty](#tree-types-and-progty)
    - [Subtyping Relation](#subtyping-relation)
      - [Structural Subtyping Axioms](#structural-subtyping-axioms)
      - [Reduction-Inspired Subtyping Axioms](#reduction-inspired-subtyping-axioms)
      - [Quantifier Distribution Axioms](#quantifier-distribution-axioms)
      - [Fixpoint Subtyping](#fixpoint-subtyping)
      - [Closure Conditions](#closure-conditions)
      - [Minimal Collection of Axioms](#minimal-collection-of-axioms)
    - [Type Derivation Rules](#type-derivation-rules)
    - [Type Constants](#type-constants)
    - [Typing of Standard Combinators](#typing-of-standard-combinators)
    - [The A Type Former](#the-a-type-former)
      - [Motivation](#motivation)
      - [Subtyping Rules for A](#subtyping-rules-for-a)
      - [Additional Axioms for bf](#additional-axioms-for-bf)
    - [Covariance and the General Triage Rule](#covariance-and-the-general-triage-rule)
    - [Typing of Generic Queries](#typing-of-generic-queries)
    - [Typing of Fixpoint Functions](#typing-of-fixpoint-functions)
    - [Typing of Lambda-Abstraction](#typing-of-lambda-abstraction)
    - [Subject Reduction](#subject-reduction)
    - [Properties of the Type System](#properties-of-the-type-system)
    - [Type Inference (Open)](#type-inference-open)
    - [Confluence and Normal Forms (from the Paper)](#confluence-and-normal-forms-from-the-paper)
  - [Equational Presentation (Book)](#equational-presentation-book)
  - [Derived Combinators (Book, Chapter 3)](#derived-combinators-book-chapter-3)
    - [Booleans](#booleans)
    - [Pairs](#pairs)
    - [Natural Numbers](#natural-numbers)
    - [Fundamental Queries](#fundamental-queries)
  - [Programs](#programs)
  - [Abstraction (Book, Chapter 4)](#abstraction-book-chapter-4)
    - [Waiting and Stable Fixpoints](#waiting-and-stable-fixpoints)
  - [Intensional Programs (Book, Chapter 5)](#intensional-programs-book-chapter-5)
    - [Verified Theorems (Book, Chapter 5)](#verified-theorems-book-chapter-5)
    - [Tagging](#tagging)
    - [Triage Combinator](#triage-combinator)
    - [Simple Types (Internal)](#simple-types-internal)
    - [Pattern Matching](#pattern-matching)
    - [Data Structures](#data-structures)
  - [Rewriting Theory (Book, Chapter 7)](#rewriting-theory-book-chapter-7)
    - [Reduction and Simultaneous Reduction](#reduction-and-simultaneous-reduction)
    - [Verified Theorems (Book, Chapter 7)](#verified-theorems-book-chapter-7)
    - [Self-Evaluator Completeness](#self-evaluator-completeness)
  - [Incompleteness of Combinatory Logic (Book, Chapter 8)](#incompleteness-of-combinatory-logic-book-chapter-8)
    - [Verified Theorems (Book, Chapter 8)](#verified-theorems-book-chapter-8)
  - [VA-Calculus (Book, Chapter 9)](#va-calculus-book-chapter-9)
    - [Verified Theorems (Book, Chapter 9)](#verified-theorems-book-chapter-9)
  - [SF-Calculus (Book, Chapter 10)](#sf-calculus-book-chapter-10)
    - [Verified Theorems (Book, Chapter 10)](#verified-theorems-book-chapter-10)
  - [Completeness Hierarchy (Book, Chapter 11)](#completeness-hierarchy-book-chapter-11)
  - [Models of Computability (Book, Appendix A)](#models-of-computability-book-appendix-a)
    - [Verified Theorems (Book, Appendix A)](#verified-theorems-book-appendix-a)
  - [Coq Formalization](#coq-formalization)
    - [File: Tree_Calculus.v (Chapters 2-3)](#file-tree_calculusv-chapters-2-3)
    - [File: Rewriting_partI.v (Chapters 3-6)](#file-rewriting_partiv-chapters-3-6)
    - [File: Rewriting_theorems.v (Chapter 7)](#file-rewriting_theoremsv-chapter-7)
    - [File: Extensional_Programs.v (Chapter 4)](#file-extensional_programsv-chapter-4)
    - [File: Intensional_Programs.v (Chapter 5)](#file-intensional_programsv-chapter-5)
    - [File: Reflective_Programs.v (Chapter 6)](#file-reflective_programsv-chapter-6)
    - [File: Incompleteness_of_Combinatory_Logic.v (Ch 8)](#file-incompleteness_of_combinatory_logicv-ch-8)
    - [File: Lambda_Abstraction_in_VA_Calculus.v (Ch 9)](#file-lambda_abstraction_in_va_calculusv-ch-9)
    - [File: Divide_and_Conquer_in_SF_Calculus.v (Ch 10)](#file-divide_and_conquer_in_sf_calculusv-ch-10)
  - [References](#references)
    - [Specification and Implementations](#specification-and-implementations)
    - [Book and Formalization](#book-and-formalization)
    - [Introductions and Blog Posts](#introductions-and-blog-posts)
