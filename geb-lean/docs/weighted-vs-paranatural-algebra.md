...
- [Weighted (Co)Ends vs Paranatural Transformations in Algebra](#weighted-coends-vs-paranatural-transformations-in-algebra)
  - [Background and Motivation](#background-and-motivation)
    - [Paranatural Transformations in Algebraic Semantics](#paranatural-transformations-in-algebraic-semantics)
    - [Weighted (Co)Ends: A Generalization](#weighted-coends-a-generalization)
    - [Research Question](#research-question)
  - [Existing Formalizations](#existing-formalizations)
    - [In ParanatAlg.lean](#in-paranatalglean)
      - [Initial Algebra Result](#initial-algebra-result)
      - [Terminal Coalgebra Result](#terminal-coalgebra-result)
    - [In DinaturalNumbers.lean](#in-dinaturalnumberslean)
      - [Church Numerals Result](#church-numerals-result)
    - [In WeightedAlg.lean](#in-weightedalglean)
      - [Mendler-Lambek Correspondence](#mendler-lambek-correspondence)
  - [Weighted (Co)End Formulations](#weighted-coend-formulations)
    - [Supporting Infrastructure](#supporting-infrastructure)
      - [In Weighted.lean](#in-weightedlean)
      - [In PowersAndCopowers.lean](#in-powersandcopowerslean)
      - [In RestrictedCoendAsColimit.lean](#in-restrictedcoendascolimitlean)
    - [Known Relationships](#known-relationships)
  - [Research Questions](#research-questions)
    - [Q1: Weighted Formulation for Initial Algebras](#q1-weighted-formulation-for-initial-algebras)
    - [Q2: Weighted Formulation for Terminal Coalgebras](#q2-weighted-formulation-for-terminal-coalgebras)
    - [Q3: Weighted Formulation for Church Numerals](#q3-weighted-formulation-for-church-numerals)
    - [Q4: Universal Property Comparison](#q4-universal-property-comparison)
  - [Mathematical References](#mathematical-references)
    - [On Paranatural Transformations](#on-paranatural-transformations)
    - [On Weighted Limits and (Co)Ends](#on-weighted-limits-and-coends)
    - [On Mendler-Style Algebras](#on-mendler-style-algebras)
    - [On Parametricity Divergence](#on-parametricity-divergence)
  - [Codebase File Map](#codebase-file-map)
    - [Core Paranatural Theory](#core-paranatural-theory)
    - [Weighted (Co)End Theory](#weighted-coend-theory)
    - [Utility Files](#utility-files)
  - [Progress and Findings](#progress-and-findings)
    - [Completed](#completed)
